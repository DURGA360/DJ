...
credentials = ServiceAccountCredentials.from_json_keyfile_name('your-credentials (1).json', ['https://spreadsheets.google.com/feeds', 'https://www.googleapis.com/auth/drive'])
...
# Define the CSS selector for the data
data_selector = '.data-class'  # Replace with the appropriate CSS selector

# Find the data using the selector
data_element = soup.select_one(data_selector)

if data_element:
    data = data_element.get_text(strip=True)
    print("Scraped Data:", data)
else:
    print("Data not found using the specified selector.")